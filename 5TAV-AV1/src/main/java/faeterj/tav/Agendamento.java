...
public class Agendamento {
	...
	public String Consulta(int idAgendamento, String nomeMedico, String endereco, int idFuncionario, LocalTime hora,
			LocalDate DataAgendamento) {
		return "Consulta marcada!"; // confirmação da marcação da consulta
	}

	// Método para verificar se o(s) exame(s) foram marcados
	public String Exame(int idAgendamento, String nomeMedico, String endereco, int idFuncionario, LocalTime hora,
			LocalDate DataAgendamento) {
		return "Exame marcado com êxito!"; // confirmação da marcação do(s) exame(s)
	}

	// Método para verificar se a internação foi realizada
	public String Internacao(int idAgendamento, String nomeMedico, String endereco, int idFuncionario, LocalTime hora,
			LocalDate DataAgendamento) {
